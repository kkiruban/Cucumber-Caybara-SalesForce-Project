...
Then(/^I enter quantity field value$/) do
  sleep 2
  if page.has_field?("Quantity01u36000003tyl8")
    fill_in("Quantity01u36000003tyl8", :with=> "10")
  else
    ...
    if (ENV['UserRole'] == "opsmgrsit")
      ...
      sleep 2
        ...
        sleep 2
          ...
          click_on "Sales Manager Alcon"
          puts "assigned to Sales Manager Alcon"
          sleep 2
        else if (ENV['UserRole'] == "salesrepsit")
            click_on "Sales Rep Alcon"
            puts "assigned to Sales Rep Alcon"
            sleep 2
              ...
              sleep 2
                ...
                puts "assigned to Sales Ops Alcon"
                sleep 2
              end
            end
          end
