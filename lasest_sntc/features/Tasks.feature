...
Feature:
  ...
  @US-003722 @nalaSalesMgr_task_1 @nalaSalesRep_task_1 @nalaOpsMgr_task_1 @nalaOpsRep_task_1 @nalaAdmin_task_1 @nalaSalesOps_task_1
...
#  @US-003712 @nalaSalesMgr_task_1 @nalaSalesRep_task_1 @nalaOpsMgr_task_1 @nalaOpsRep_task_1 @nalaAdmin_task_1 @nalaSalesOps_task_1
#  Scenario: US-003712 The buttons should be removed from all profiles
#    Given I should navigate to "Accounts" tab
#    When I click on new button under accounts section
#    And I enter data to all mandatory fields under new account
#    And I click on "Save" button from top row
#    Then I click on new task button under open activities section
#    Then I select "Task - Health Check" from record type of new record
#    And I enter data to all the mandatory fields
#    Then I click on "Save" button from top row
