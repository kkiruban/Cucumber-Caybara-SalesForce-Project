...
And(/^I verify the "([^"]*)" text field should be editable for all users except salesOps$/) do |asset_name|
  begin
    sleep 3
    arg = getDetails 'NewAssetInformation'
...
When(/^I verify the "([^"]*)" lookup field should be visible in the right column under "([^"]*)" section$/) do |asset_owner, asset_information|
  begin
    sleep 3
